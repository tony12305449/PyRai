...
#CGO_ENABLED=0 GOOS=windows GOARCH=386 go build -ldflags="-s -w" -o ../${output_folder}/windows_386_scanner
#CGO_ENABLED=0 GOOS=windows GOARCH=amd64 go build -ldflags="-s -w" -o ../${output_folder}/windows_amd64_scanner
#CGO_ENABLED=0 GOOS=windows GOARCH=arm go build -ldflags="-s -w" -o ../${output_folder}/windows_arm_scanner
#CGO_ENABLED=0 GOOS=windows GOARCH=arm64 go build -ldflags="-s -w" -o ../${output_folder}/windows_arm64_scanner
cd ..
...
#CGO_ENABLED=0 GOOS=windows GOARCH=386 go build -ldflags="-s -w" -o ../${output_folder}/windows_386_loader
#CGO_ENABLED=0 GOOS=windows GOARCH=amd64 go build -ldflags="-s -w" -o ../${output_folder}/windows_amd64_loader
#CGO_ENABLED=0 GOOS=windows GOARCH=arm go build -ldflags="-s -w" -o ../${output_folder}/windows_arm_loader
#CGO_ENABLED=0 GOOS=windows GOARCH=arm64 go build -ldflags="-s -w" -o ../${output_folder}/windows_arm64_scanner
cd ..
